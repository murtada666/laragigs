<x-layout>
    <x-card class="p-10 max-w-lg mx-auto mt-24">
                    ...
                    {{-- We are trying to make a PUT request but we can just change the method to PUT so we will use @method directive. --}}
                    <form action="/listings/{{$listing->id}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <input
                                type="text" class="border border-gray-200 rounded p-2 w-full" name="title" placeholder="Example: Senior Laravel Developer" value="{{$listing->title}}"/>
